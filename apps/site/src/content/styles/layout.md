...
| 800px to 1023px  | 12                  | 32px          | 58px to 80px  | fluid           |
| 1024px and above | 12                  | 32px          | 80px to 128px | max 1512px      |
...
| `--desktop` | 1024px and up | `-from-desktop` variants take effect |
